...
public class GPSCoordinateUtils {
	...
	static final double WGSb = 6356752.314245; 
	static final double WGSf = 1 / 298.257223563; 
	 ...
	 * 
	 * @param distance
	 * @param initialBearing - the 
	 * @return
	 * @throws Exception 
	 */
	private static GPSCoordinate vincentyGeodesicDirect(GPSCoordinate coord, double distance, double initialBearing) throws Exception {
	    ...
	    return new GPSCoordinate(Math.toDegrees(Phi2), Math.toDegrees(Lambda2));
//	    return {
...
//	    }
	...
	//private 
	private static double vincentyGeodesicOne(GPSCoordinate from, GPSCoordinate to) throws Exception {
...
//		    Alpha2 = (Alpha2 + 2*Math.PI) % (2*Math.PI); // normalise to 0..360
	...
	public static double getDistanceMetresBetweenWGS84(GPSCoordinate from, GPSCoordinate to) throws Exception {
		//returns the length of the geodesic from coordinate from to coordinate to
		return vincentyGeodesicOne(from, to);
	}
	
	public static double getDistanceMetresLatToOther(GPSCoordinate from, GPSCoordinate to) throws Exception {
		...
		return vincentyGeodesicOne(from, new GPSCoordinate(to.getLat(), from.getLng()));
	}
	
	public static double getDistanceMetresLngToOther(GPSCoordinate from, GPSCoordinate to) throws Exception {
		...
		return vincentyGeodesicOne(from, new GPSCoordinate(from.getLat(), to.getLng()));
	}
