...
class MapEdge 
{
	 ...
	 */	
	MapEdge(MapNode n1, MapNode n2) 
	{
		start = n1;
		end = n2;
		this.length = n1.getLocation().getMetresToOther(n1.getLocation());
		//this.length = length;
	}
	...
	public String toString()
	{
		...
		toReturn += "\n\t" + start.getLocation();
		toReturn += "\n\t" + end.getLocation();
		toReturn += "Segment length: " + String.format("%.3g", length) + "km";
