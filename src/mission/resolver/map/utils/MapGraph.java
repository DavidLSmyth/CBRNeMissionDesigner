...
public class MapGraph {
	...
	private HashMap<GPSCoordinate, MapNode> pointNodeMap;
	...
	public MapGraph()
	{
		pointNodeMap = new HashMap<GPSCoordinate,MapNode>();
	 ...
	 * @return The vertices in this graph as GPSCoordinates
	 */
	public Set<GPSCoordinate> getVertices()
	{
	 ...
	 */
	public boolean addVertex(GPSCoordinate location)
	{
		if (location == null) {
			return false;
		}
	 ...
	 * Precondition: Both GPSCoordinates have already been added to the graph
	 ...
	 */
	public void addEdge(GPSCoordinate from, GPSCoordinate to) throws IllegalArgumentException {
	 ...
	 */
	public List<GPSCoordinate> bfs(GPSCoordinate start, GPSCoordinate goal) {
		// Dummy variable for calling the search algorithms
        Consumer<GPSCoordinate> temp = (x) -> {};
	 ...
	 *   path from start to goal (including both start and goal).
	 */
	public List<GPSCoordinate> bfs(GPSCoordinate start, 
			 					     GPSCoordinate goal, 
			 					     Consumer<GPSCoordinate> nodeSearched)
	{
	 ...
	 */
	private List<GPSCoordinate>
	reconstructPath(HashMap<MapNode,MapNode> parentMap,
					MapNode start, MapNode goal)
	{
		LinkedList<GPSCoordinate> path = new LinkedList<GPSCoordinate>();
	 ...
	 *   start to goal (including both start and goal).
	 */
	public List<GPSCoordinate> dijkstra(GPSCoordinate start, GPSCoordinate goal) {
		// Dummy variable for calling the search algorithms
	 ...
	 *   start to goal (including both start and goal).
	 */
	public List<GPSCoordinate> dijkstra(GPSCoordinate start, 
										  GPSCoordinate goal, Consumer<GPSCoordinate> nodeSearched)
	{
	 ...
	 *   start to goal (including both start and goal).
	 */
	public List<GPSCoordinate> aStarSearch(GPSCoordinate start, GPSCoordinate goal) {
		// Dummy variable for calling the search algorithms
        Consumer<GPSCoordinate> temp = (x) -> {};
	 ...
	 *   start to goal (including both start and goal).
	 */
	public List<GPSCoordinate> aStarSearch(GPSCoordinate start, 
											 GPSCoordinate goal, Consumer<GPSCoordinate> nodeSearched)
	{
		// TODO: Implement this method in WEEK 3
